# Реализуйте класс Promo code, который содержит 3 метода:
# 1. insert(code) - добавляет код со значением code
# 2. remove(code) - удаляет код со значением code
# 3. getRandom() - возвращает значение случайно выбранного кода.
